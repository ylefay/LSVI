...
from LSVI.experiments.time_wrapper import timer
from LSVI.variational.exponential_family import GenericMeanFieldNormalDistribution, NormalDistribution
from LSVI.variational.exponential_family import MeanFieldNormalDistribution
from LSVI.variational.meanfield_gaussian_lsvi import mean_field_gaussian_lsvi
from LSVI.experiments.logisticRegression.subsampling_review.ngd import ngd_on_mf_gaussian_kl
from LSVI.experiments.logisticRegression.subsampling_review.heuristic_and_non_heuristic_gaussianMeanField_NIcolas import \
